  ...
  return (
    <div className="login-form">
      ...
      <form className="form form--login" onSubmit={handleSubmit}>
        ...
        <div className="form__group">
          <button className="btn btn--green btn--small" type="submit">
            Signup
          </button>
        </div>
      </form>
